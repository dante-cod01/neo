 ...
 */
import * as component from "/app/runtime/componentLoader.js"

const drawPanelBox = async (box) => {
    /* panel-box component */
    const componentMod = { "magicBox": "/app/components/comp_classes/nano/boxes/magicBox.js" }
 ...
 *//*     const componentLoaded = await component.load(componentMod, conf, "panelConfig panel absolute", box)
 */    const componentLoaded = await component.load(componentMod, dependencies,  box, "")
